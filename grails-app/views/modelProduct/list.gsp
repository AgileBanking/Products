	...
	<body>
		...
		<div id="list-modelProduct" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="notes" title="${message(code: 'modelProduct.notes.label', default: 'Notes')}" />
				...
				<g:each in="${modelProductInstanceList}" status="i" var="modelProductInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: modelProductInstance, field: "notes")}</td>
			...
			<div class="pagination">
				<g:paginate total="${modelProductInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
